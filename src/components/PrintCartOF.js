        ...
        <div className="w-[100%] p-[2rem] bg-[#ffffff] text-[#000000]">
            ...
            <div className="flex flex-col justify-end items-end mt-[5rem] text-center">
                ...
                <div className="flex">
                    ...
                    <p className="_print-text">{store.reduceAuthCartProduktyNettoNOPRICE()} zł</p>
                ...
                <div className="flex">
                    ...
                    <p className="_print-text">{store.reduceAuthCartProduktyBruttoNOPRICE()} zł</p>
